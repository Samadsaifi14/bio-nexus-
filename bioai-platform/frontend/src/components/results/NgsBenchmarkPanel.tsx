...
export function NgsBenchmarkPanel({ claim, summary, sameOrBetterSupported = false, comparisons = [], analysisGrade, researchReady = false, requirements = [], inputSampling, demonstration = false }: NgsBenchmarkPanelProps) {
