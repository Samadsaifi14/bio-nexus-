...
export default function SettingsPage() {
  ...
  return (
    <div className="max-w-3xl space-y-8">
      <PageHeader title="Settings" subtitle="Manage your profile, usage, and preferences" />
            ...
            <div className="space-y-5">
              ...
              {isGuest ? (
                <div className="rounded-xl bg-accent-cyan/5 border border-accent-cyan/15 p-5 text-center">
                  ...
                  <CriticalButton onClick={() => upgradeToAccount()}>
                ...
                <div className="flex items-center justify-between pt-1">
                  <CriticalButton onClick={handleSave} disabled={saving} loading={saving}>
              ...
              {newKeyValue ? (
                <div className="p-4 rounded-xl bg-accent-cyan/5 border border-accent-cyan/15">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="px-3 py-2 text-xs flex items-center gap-1 shrink-0 rounded-lg bg-surface-1 border border-surface-3 text-text-secondary hover:text-text-primary hover:border-accent-cyan/40 transition"
                    >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <CriticalButton
                    ...
                    loading={creatingKey}
                  >
                    {!creatingKey && <Plus className="w-4 h-4" />}
                    Generate
                  </CriticalButton>
                </div>
              )}
