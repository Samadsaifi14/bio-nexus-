...
echo "==> Installing system dependencies (openbabel, wget, ca-certificates)"
apt-get update && apt-get install -y --no-install-recommends openbabel wget ca-certificates
