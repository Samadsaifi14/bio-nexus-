...
def _run_openmm(
    ...
    return _to_native({
        ...
        "energy_source": "OpenMM potential energy (implicit solvent)",
...
def _run_biopython_analysis(pdb_path: str, pdb_id: str, mode: str, reason: str = "OpenMM not available", diagnostics: str | None = None) -> dict:
    ...
    return _to_native({
        ...
        "energy_source": "harmonic bond-geometry estimate (no force field; not a validated potential energy)",
        "estimated_energy_kj_mol": estimated_energy_kj,
        "energy": energy_data,
        "rmsd": rmsd_data,
