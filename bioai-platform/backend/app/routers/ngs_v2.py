...
def analyze(payload: AnalyzeRequest):
    ...
    # Preserve both mates in downstream QC/alignment. The previous implementation counted
    # R1+R2 in reads_loaded but analyzed only the first FASTQ, producing misleading results.
